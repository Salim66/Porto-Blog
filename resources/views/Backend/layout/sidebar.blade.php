      ...
      <ul class="iconMenu-bar custom-scrollbar">
        ...
        <li><a class="bar-icons" href="javascript:void(0)"><i class="fas fa-users"></i><span>Users Manage</span></a>
          <ul class="iconbar-mainmenu custom-scrollbar">
            ...
            <li><a href="{{ route('users.trash') }}">Trash List <span class="text-danger" id="total_user_trash_count"></span></a></li>
          </ul>
        </li>
        @endif
        ...
        <li><a class="bar-icons" href="javascript:void(0)"><i class="fas fa-tags"></i><span>Tags</span></a>
          <ul class="iconbar-mainmenu custom-scrollbar">
            ...
            <li><a href="{{ route('tags.trash') }}">Trash List <span class="text-danger" id="total_tag_trash_count"></span></a></li>
          </ul>
        </li>
